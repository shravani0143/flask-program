...
class app(Flask):
	"""Flask application containing the college details endpoint."""

	def __init__(self, import_name=__name__):
		super().__init__(import_name)
		self.add_url_rule('/', view_func=self.college)

	def college(self):
		"""Return the college details page."""
		return """<h1>College Details</h1>
		<hr>
